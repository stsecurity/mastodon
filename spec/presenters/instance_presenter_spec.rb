...
describe InstancePresenter do
  ...
  describe '#source_url' do
    it 'returns "https://github.com/stsecurity/mastodon/tree/lilymagic"' do
      expect(instance_presenter.source_url).to eq('https://github.com/stsecurity/mastodon/tree/lilymagic')
    end
  end
