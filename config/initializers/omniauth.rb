...
Devise.setup do |config|
  ...
  if ENV['CAS_ENABLED'] == 'true'
    cas_options = {}
    cas_options[:display_name] = 'cas' || ENV['CAS_DISPLAY_NAME']
  ...
  if ENV['SAML_ENABLED'] == 'true'
    saml_options = {}
    saml_options[:display_name] = 'saml' || ENV['SAML_DISPLAY_NAME']
  ...
  if ENV['OIDC_ENABLED'] == 'true'
    oidc_options = {}
    oidc_options[:display_name] = 'openid_connect' || ENV['OIDC_DISPLAY_NAME'] #OPTIONAL
